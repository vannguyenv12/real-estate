...
if (isset($_POST['form_submit'])) {
    try {
        ...
        $statement->execute([$_REQUEST['id'], $_SESSION['customer']['id'], $result[0]['agent_id'], 'Customer', $_POST['reply'], date('Y-m-d H:i:s')]);
                ...
                <div class="message-item message-item-main">
                    <div class="message-top">
                        <div class="photo">
                            ...
                            <?php else : ?>
                                <img src="<?php echo BASE_URL; ?>uploads/<?php echo $_SESSION['customer']['photo']; ?>" alt="">
                            <?php endif; ?>
                        </div>
                        <div class="text">
                            <h6><?php echo $_SESSION['customer']['full_name']; ?> <span class="badge rounded-pill text-bg-primary">Customer</span></h6>
                    ...
                    <div class="message-item">
                        <div class="message-top">
                            ...
                            <div class="text">
                                <h6>
                                    <?php if ($row['sender'] == 'Customer') : ?>
                                        <?php echo $_SESSION['customer']['full_name']; ?> <span class="badge rounded-pill text-bg-primary">Customer</span>
                                    <?php else : ?>
